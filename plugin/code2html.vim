...
" Last Change: Tue Jul 02 03:00 PM 2002 EDT
"	       (modified by David Ne\v{c}as (Yeti) <yeti@physics.muni.cz>)
"  (modified by Soren Andersen [perlspinr] <libertador@flashmail.com>)
...
if has("gui_running")
  let s:whatterm = "gui"
 if strlen(&guifont)
		 let SA_guifont = substitute(substitute(&guifont, '\(\a\{-\}\)_',' \"\1 ', "g"),':h\(\d\+\)','\" \1pt','g')
 else
		 let SA_guifont =
 endif
else
...
" incorrect.
if exists("html_use_css")
  exec "normal A\npre { color: " . s:fgc . "; background-color: " . s:bgc . "; font: " .SA_guifont .", \"courier new\" 9pt; font-size-adjust: 0.50; }\n\e"
"  yank
"  put
"  execute "normal ^cwbody\e"
  exec "normal A\nbody { color: #FFFFFF; background-color: #000200;\n   padding: 9 0; margin: 0; }\e"
else
